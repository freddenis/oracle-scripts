...
# History :
#
# 20190130 - Fred Denis - 11g support (break on INTERNAL_STATE instead of INSTANCE_COUNT)
                        ...
                        {           NB = 0      ;       # Number of instance as CARDINALITY_ID is sometimes irrelevant
                                ...
                                while (getline)
                                {
                                        ...
                                        if ($1 == "STATE_DETAILS")      {       NB++                                    ;       # Number of instances we came through
                                                                                ...
                                                                                #if ($0 ~ /^$/) { getline whatsnext; if (whatsnext ~ /NAME=/) { print "break" SERVER,DB,STATE,whatsnext,$0 ; break ;} }
                                                                        if ($1 == "BREAK_HERE") { break;}
                                         #if ($1 == "INSTANCE_COUNT")     {       if (NB == $2) { print "break" SERVER,DB,STATE,whatsnext,$0; break                   ;}}            # 12c
                                         #if ($1 == "INTERNAL_STATE")     {       if (NB == n)  { break                   ;}}           # 11g
                                }
                        }
                }       # End of if ($1 ~ /^NAME/)
            }
